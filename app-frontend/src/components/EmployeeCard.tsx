...
export const EmployeeCard: React.FC<EmployeeCardProps> = ({ employee, onClick }) => {
  ...
  return (
    <div
      className="w-full max-w-2xl mx-auto bg-white rounded-2xl shadow-lg overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-300 cursor-pointer"
      onClick={onClick}
    >
      {/* Profile content */}
      <div className="px-8 pb-8">
        {/* Avatar and header removed */}
